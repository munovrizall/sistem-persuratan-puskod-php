...
include $rootPath . "/sistem-persuratan-puskod/config/connection-auth-staff.php";
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        include $rootPath . "/sistem-persuratan-puskod/components/sidebar-staff.php";
        ?>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/sistem-persuratan-puskod/staff/surat-masuk.php">Surat Masuk</a></li>
